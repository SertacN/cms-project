...
export class CreateParameterDialog {
  ...
  private readonly dialogRef = inject(MatDialogRef<CreateParameterDialog>);
  ...
  get options() { return this.parameterForm.get('options') as FormArray; }
  get orderBy() { return this.parameterForm.controls.orderBy; }
